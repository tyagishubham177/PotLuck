...
| Area | Included |
| --- | --- |
| Rooms | Create, join by code, renew code, waiting list |
| Seating | Seat select, seat reservation, sit out, queue auto-seat |
...
| Area | Excluded |
| --- | --- |
| Real money | Payments, withdrawals, AML/KYC, rake accounting for cash games |
| Tournament systems | Blinds schedules, late reg, prize pools |
| Multi-table | Table balancing or movement |
| Alternate variants | Omaha, Short Deck, mixed games |
| Complex side features | Run it twice, bomb pots, rabbit hunt |
