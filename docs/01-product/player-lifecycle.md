...
| Reserved | Seat selected, buy-in pending | Seat reservation | Seated, Lobby, Disconnected |
...
| Busted | Zero room chips and no rebuy path taken | Settlement | Lobby, Disconnected |
...
- Admin can mute chat/reactions without affecting game participation.
